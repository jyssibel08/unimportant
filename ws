...
<html lang="en">
   ...
   <head>
      <meta charset="utf-8" />
      <title>XAMJYSS143 Script OVPN Config Download</title>
      <meta name="description" content="XAMJYSS143 Script Server" />
   ...
   <body>
      <div class="container justify-content-center" style="margin-top:9em;margin-bottom:5em;">
         <div class="col-md">
            ...
            <div class="card">
               <div class="card-body">
                  <h5 class="card-title">XAMJYSS143 OVPN Config List</h5>
                  <br />
                  <ul class="list-group">
                    <li class="list-group-item justify-content-between align-items-center" style="margin-bottom:1em;">
                        <p>ALL IN ONE CONFIGS <span class="badge light-blue darken-4">Android/iOS/PC/MODEM</span><br /><small>ALL CONFIGS</small></p>
                        <a class="btn btn-outline-success waves-effect btn-sm" href="http://43.243.127.35:86/Configs.zip" style="float:right;"><i class="fa fa-download"></i> Download</a>
                     </li> 
                    <li class="list-group-item justify-content-between align-items-center" style="margin-bottom:1em;">
                        <p>For OVPN WS <span class="badge light-blue darken-4">Android/iOS/PC/MODEM</span><br /><small> For OVPN Websocket GTM NOLOAD</small></p>
                        <a class="btn btn-outline-success waves-effect btn-sm" href="http://43.243.127.35:86/Default.ovpn" style="float:right;"><i class="fa fa-download"></i> Download</a>
                     </li>
                     <li class="list-group-item justify-content-between align-items-center" style="margin-bottom:1em;">
                        <p>For Globe/TM <span class="badge light-blue darken-4">Android/iOS/PC/MODEM</span><br /><small> For EZ/GS Promo with WNP freebies</small></p>
                        <a class="btn btn-outline-success waves-effect btn-sm" href="http://43.243.127.35:86/GTMConfig.ovpn" style="float:right;"><i class="fa fa-download"></i> Download</a>
                     </li>
                     <li class="list-group-item justify-content-between align-items-center" style="margin-bottom:1em;">
                        <p>For Sun <span class="badge light-blue darken-4">Android/iOS/PC/Modem</span><br /><small> For TU/CTC UDP Promos</small></p>
                        <a class="btn btn-outline-success waves-effect btn-sm" href="http://43.243.127.35:86/XJ-TU-UDP.ovpn" style="float:right;"><i class="fa fa-download"></i> Download</a>
                     </li>
                     <li class="list-group-item justify-content-between align-items-center" style="margin-bottom:1em;">
                        <p>For Sun/SMART/TNT <span class="badge light-blue darken-4">Android/iOS/PC/MODEM</span><br /><small> TNT GIGASTORIES</small></p>
                        <a class="btn btn-outline-success waves-effect btn-sm" href="http://43.243.127.35:86/XJ-Stories-TCP.ovpn" style="float:right;"><i class="fa fa-download"></i> Download</a>
                     </li>
                  </ul>
               </div>
            </div>
